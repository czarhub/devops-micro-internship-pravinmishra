...
![image](screenshots/Week04-Assignment01-Screenshot01.jpg)



#### Screenshot 2 — Output of `ls -a` showing the `.git` folder

![image](screenshots/Week04-Assignment01-Screenshot02.jpg)
...
The .git folder is a hidden directory that Git creates when you initialize a repository. It stores all the project's version history, commits, branches, tags, and configuration.

Why it matters:
Without the .git folder, your project is just a collection of files. With it, Git can track changes, let you undo mistakes, collaborate with others, and manage different versions of your code.
...
![image](screenshots/Week04-Assignment01-Screenshot03.jpg)
...
![image](screenshots/Week04-Assignment01-Screenshot04.jpg)
